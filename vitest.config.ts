...
export default defineConfig({
  test: {
    ...
    env: {
      ...
      PLATFORM_JWT_ACCESS_SECRET: 'test-platform-access-secret-32-chars-padding!!',
      PLATFORM_JWT_REFRESH_SECRET: 'test-platform-refresh-secret-32-chars-padding!',
      PLATFORM_JWT_ACCESS_EXPIRY: '15m',
